"""Сгенерировать забавные имена, случайно комбинирую имена
...
def main():
    ...
    print("Добро пожаловать в 'Подбор имён для напарника' "
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
        ...
        'Rubbins', 'Sackrider', 'Snuggleshine', 'Splern',
    ...
    try_again = input("\n\nПопробуете ещё? (Нажмите "
                    "Enter либо n, чтоб выйти)\n")
